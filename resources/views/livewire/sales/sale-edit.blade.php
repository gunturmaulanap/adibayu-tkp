<div>
    <div x-data="{ showModal: false }" x-on:toggle-item-modal.window="showModal = !showModal"
        ...
        <div class="relative mb-6 w-full">
            <flux:heading size="xl" level="1">{{ __('Edit Penjualan') }}</flux:heading>
            <flux:subheading size="lg" class="mb-6">{{ __('Perbarui detail transaksi di bawah ini') }}
            </flux:subheading>
            ...
            <div class="p-4 bg-white rounded-lg shadow-md">
                                    ...
                                    <td class="px-4 py-2">
                                        <div class="flex items-center">
                                            ...
                                            <input type="number" wire:model.live="items.{{ $index }}.qty"
                                                class="w-16 text-center bg-gray-50 border-t border-b border-gray-300 text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500"
                                                min="1">
                ...
                <div class="mt-6 flex justify-end items-center">
                    ...
                    <span class="text-xl font-bold text-gray-800">Grand Total: Rp
                        {{ number_format($grand_total ?? $this->totalPrice, 0, ',', '.') }}</span>
                </div>
                ...
                <div class="mt-6 flex justify-start border-t pt-4">
                    ...
                    <button type="submit"
                        ...
                        <span wire:loading.remove wire:target="save">Updated Penjualan</span>
                    </button>
                </div>
            </div>
        </form>
