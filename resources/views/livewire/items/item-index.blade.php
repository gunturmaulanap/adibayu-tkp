<div>
    <div class="relative mb-6 w-full">
        <flux:heading size="xl" level="1">{{ __('Items') }}</flux:heading>
        <flux:subheading size="lg" class="mb-6">{{ __('Manage your all items') }}
        </flux:subheading>
                ...
                <tbody>
                    ...
                    @forelse ($items as $item)
                        <tr class="odd:bg-white even:bg-gray-50 border-b border-gray-200">
                            <td class="px-6 py-2 text-gray-700">{{ $item->code }}</td>
                            ...
                            <td class="px-6 py-2">
                                ...
                                @else
                                    <div
                                        class="h-12 w-12 bg-gray-100 flex items-center justify-center rounded text-sm text-gray-400">
                                        No image
                                    </div>
                                @endif
                            </td>
                            <td class="px-6 py-2 text-gray-700">{{ $item->price_formatted }}</td>
                            <td class="px-6 py-2 text-gray-700">{{ $item->stock }}</td>
